        ...
        <AuthLayout>
            <div className="w-full flex flex-col md:flex-row overflow-hidden">
                ...
                <div className="hidden md:flex md:w-1/2 pr-6 lg:pr-12 py-10 lg:py-20 flex-col justify-between">
                    <div>
                        <h1 className="text-4xl lg:text-6xl font-semibold mb-8">Instantly Confirm Your Device's <span className='text-[#D62027]'>Authenticity.</span></h1>
                ...
                <div className="w-full md:w-1/2 p-8 lg:p-12 bg-white">
                    <h2 className="text-2xl lg:text-4xl font-medium mb-2">Welcome back</h2>
                    <p className="opacity-40 text-xs lg:text-sm font-normal mb-8">Welcome back! Please enter your details.</p>
                    <LoginForm />
