...
export default function DashboardPage() {
    ...
    return (
        <div className="container mx-auto rounded-3xl p-10 mt-36 bg-white">
                    ...
                    <div className="flex space-x-4 w-full sm:w-auto">
                        <div className="relative flex-1 sm:flex-none">
                            ...
                            <input
                                ...
                                className="pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-red-500 w-full sm:w-64"
                            />
                        </div>
                        <input
                            type="date"
